...
class StudentDAOTest {
	private static Logger logger = LogManager.getLogger(StudentDAOTest.class);
	...
	void shouldCreateStudentInDatabase() {
		...
		try(PreparedStatement preparedStatement = ConnectionFactory.getConnection().prepareStatement(query)) {
			...
			logger.error("cannot get connection in method shouldCreateStudentInDatabase of StudentDAOTest class", e);
		}
	...
	void shouldSetGroupForStudent() {
		...
		try (PreparedStatement preparedStatement = ConnectionFactory.getConnection().prepareStatement(query)) {
			...
			logger.error("cannot get connection in method shouldSetGroupForStudent of StudentDAOTest class", e);
		}
